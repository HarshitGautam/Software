...
<?php require('header.php'); ?>
    ...
    <div class="content">
        ...
        <br/>
        <p style="text-align: justify">
            The most up-to-date ontology files can be accessible
            <a href="https://github.com/OmniSearch/omit" target="_blank"><b>here</b></a>.
            <br/><br/>
            Besides, the OMIT ontology is also included in both
            <a href="http://obofoundry.org/ontology/omit.html" target="_blank"><b>the OBO Library</b></a> and
            <a href="http://bioportal.bioontology.org/ontologies/OMIT" target="_blank"><b>the NCBO BioPortal</b></a>.
        </p>
        <br/>
        <!--
        <div class="hr">
        ...
        <br/>
        <p style="text-align: justify">
            All files for the NCRO ontology can be found <a href="https://github.com/OmniSearch/ncro" target="_blank"><b>here</b></a>.
        </p>
        <br/>
        <div class="hr">
            <hr/>
        ...
        <div style="text-align:left">
            ...
            1. J. Huang, J. Dang, G.M. Borchert, K. Eilbeck, H. Zhang, M. Xiong, W. Jiang, H. Wu, J.A. Blake, D.A. Natale, and M. Tan, <a href="http://www.plosone.org/article/info%3Adoi%2F10.1371%2Fjournal.pone.0100855" target="_blank">OMIT: Dynamic, Semi-Automated Ontology Development for the microRNA
                Domain</a>, PLOS ONE, 9(7): 1-16, e100855, July 2014 (doi:10.1371/journal.pone.0100855).<br/><br/>
        ...
        <div style="text-align:left">
            ...
            1. J. Huang, K. Eilbeck, J.A. Blake, D. Dou, D.A. Natale, A. Ruttenberg, B. Smith, M.T. Zimmermann, G. Jiang, Y. Lin, B. Wu, Y. He, S. Zhang, X. Wang, H. Zhang, Z. Liu, and M. Tan, <a href="http://soc.southalabama.edu/~huang/papers/BIBM-15-1.pdf" target="_blank">A domain ontology for the
                non-coding RNA field</a>, Proc. 2015 IEEE International Conference on Bioinformatics and Biomedicine (BIBM-15), pp. 621-624, IEEE, Washington D.C., November 2015.
        </div>
    </div>

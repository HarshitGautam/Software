...
try {
	...
	$error = $having == $default_having ? '<br/>There are no predicted/validated microRNAs for  ' . $gene . '. <br/><br/>Visit <a href="http://amigo.geneontology.org/amigo/search/annotation?fq=taxon_label:%22Homo%20sapiens%22&q=%22' . $gene . '" target="_blank">Gene Ontology Annotation</a> to search more databases.' : 'No results found.<br/><br/>Add/Remove one or more filters to show results.';
    ...
    $query = 'PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> ' .
        ...
        'WHERE { ' .
        '?target rdfs:label "' . $gene . '"^^xsd:string . ' .
        '?prediction obo:OMIT_0000160 ?target . ' .
        '?prediction obo:OMIT_0000159 ?mirna . ' .
		 (!empty($mirna) ?
                '?mirna rdfs:label ?mirna_label ' .
                'FILTER REGEX(?mirna_label, "' . $mirna . '"^^xsd:string, "i") ' : '?mirna rdfs:label ?mirna_label .') .
